...
/** The convention-lens tab strip (semantic `role="tablist"`). Each tab shows its
 *  label, an open-finding count, and a live pulse while its pass runs. */
export function CategoryTabs({ tabs, active, onSelect }: CategoryTabsProps) {
  return (
    <div
      role="tablist"
      aria-label="Convention lenses"
        ...
        return (
          ...
          >
            ...
            {tab.running ? (
              ...
              <span aria-label="scan failed" className="ml-0.5 text-[10px] font-semibold text-destructive">
                !
              </span>
            ) : null}
          </button>
