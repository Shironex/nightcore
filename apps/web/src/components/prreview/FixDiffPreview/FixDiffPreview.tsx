...
export function FixDiffPreview({
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 rounded-[8px] border border-border bg-black/20 px-3 py-2 text-[12px] text-muted-foreground">
        <Spinner size={13} />
  ...
  if (error !== null) {
    return (
      <div className="rounded-[8px] border border-border bg-black/20 px-3 py-2 text-[12px] text-muted-foreground">
  ...
  return (
    <div className="flex flex-col gap-1.5 rounded-[8px] border border-border bg-black/20 p-2">
      <div className="flex items-center justify-between px-1">
        ...
        {summary.length > 0 && (
          <span className="font-mono text-[11px] text-muted-foreground" title={summary}>
            {summary}
          </span>
        )}
      </div>
          ...
          return (
            <li key={file.path} className="flex flex-col">
              ...
              >
                ...
                <span
                  aria-hidden
                  className="w-3 shrink-0 text-center font-mono text-[11px] text-muted-foreground"
                >
